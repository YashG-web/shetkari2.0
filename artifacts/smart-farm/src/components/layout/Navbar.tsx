...
export function Navbar() {
  ...
  const navLinks = [
    { path: '/', label: tr('nav.dashboard') },
    { path: '/live-data', label: tr('nav.live_data') },
    { path: '/recommendation', label: tr('nav.recommendation') },
    { path: '/fertilizer', label: tr('nav.fertilizers') },
    { path: '/crop-analysis', label: tr('nav.crop_analysis') },
    { path: '/simulator', label: tr('nav.simulator') },
  ];
