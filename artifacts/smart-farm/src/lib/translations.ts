...
export const t: TranslationMap = {
  ...
  // Precision Farming
  "pf.title": { en: "AGRI-OPTIX PRO", hi: "एग्री-ऑप्टिक्स प्रो", mr: "अॅग्री-ऑप्टिक्स प्रो" },
  "pf.my_field": { en: "My Field", hi: "मेरा खेत", mr: "माझे शेत" },
  "pf.precision_optimized": { en: "Precision Optimized", hi: "प्रेसिजन ऑप्टिमाइज्ड", mr: "अचूकता ऑप्टिमाइझ केलेले" },
  "pf.subtitle": { en: "Automated Precision Farming & Resource Intelligence v4.0", hi: "स्वचालित सटीक खेती और संसाधन इंटेलिजेंस", mr: "स्वयंचलित अचूक शेती आणि संसाधन बुद्धिमत्ता" },
  "pf.no_farmland_detected": { en: "NO FARMLAND DETECTED. SWITCHING TO DEMO MODE.", hi: "कोई खेत नहीं मिला। डेमो मोड पर जा रहे हैं।", mr: "कोणतीही शेतजमीन आढळली नाही. डेमो मोडवर जात आहे." },
  "pf.live_gps_active": { en: "LIVE GPS ACTIVE", hi: "लाइव जीपीएस सक्रिय", mr: "थेट जीपीएस सक्रिय" },
  "pf.enable_live_farm": { en: "ENABLE LIVE FARM MODE", hi: "लाइव फार्म मोड सक्षम करें", mr: "लाइव्ह फार्म मोड सक्षम करा" },
  "pf.terrain_analysis": { en: "TERRAIN ANALYSIS", hi: "इलाक़े का विश्लेषण", mr: "भूप्रदेशाचे विश्लेषण" },
  "pf.scanning": { en: "Scanning Multi-Spectral Band Sentinel-2", hi: "मल्टी-स्पेक्ट्रल बैंड सेंटिनल-2 को स्कैन किया जा रहा है", mr: "मल्टी-स्पेक्ट्रल बँड सेंटिनेल-२ स्कॅन करत आहे" },
  "pf.parcel_confidence": { en: "Parcel Confidence", hi: "पार्सल कॉन्फिडेंस", mr: "पार्सल आत्मविश्वास" },
  "pf.upload_plot_doc": { en: "Upload Plot Doc", hi: "प्लॉट दस्तावेज़ अपलोड करें", mr: "प्लॉट दस्तऐवज अपलोड करा" },
  "pf.field_area": { en: "Field Area", hi: "खेत का क्षेत्र", mr: "शेताचे क्षेत्र" },
  "pf.hectare": { en: "HECTARE", hi: "हेक्टेयर", mr: "हेक्टर" },
  "pf.optimal": { en: "OPTIMAL", hi: "इष्टतम", mr: "इष्टतम" },
  "pf.moderate": { en: "MODERATE", hi: "मध्यम", mr: "मध्यम" },
  "pf.critical": { en: "CRITICAL", hi: "गंभीर", mr: "गंभीर" },
  "pf.parcel_coordinates": { en: "PARCEL COORDINATES", hi: "पार्सल निर्देशांक", mr: "पार्सल निर्देशांक" },
  "pf.drone_command": { en: "DRONE COMMAND CENTER", hi: "ड्रोन कमांड सेंटर", mr: "ड्रोन कमांड सेंटर" },
  "pf.ready_for_deployment": { en: "READY FOR DEPLOYMENT", hi: "तैनाती के लिए तैयार", mr: "तैनातीसाठी सज्ज" },
  "pf.red_zones": { en: "Red Zones Targeted", hi: "लाल क्षेत्र लक्षित", mr: "रेड झोन्स लक्ष्यित" },
  "pf.mission_eta": { en: "Mission ETA", hi: "मिशन ईटीए", mr: "मिशनची अंदाजित वेळ" },
  "pf.telemetry_status": { en: "Telemetry Status", hi: "टेलीमेट्री स्थिति", mr: "टेलीमेट्री स्थिती" },
  "pf.mission_active": { en: "Mission Active", hi: "मिशन सक्रिय", mr: "मिशन सक्रिय" },
  "pf.launch_mission": { en: "Launch Drone", hi: "ड्रोन लॉन्च करें", mr: "ड्रोन लाँच करा" },
  "pf.resource_matrix": { en: "Resource Matrix", hi: "संसाधन मैट्रिक्स", mr: "संसाधन मॅट्रिक्स" },
  "pf.water_matrix": { en: "Water Matrix Needed", hi: "आवश्यक जल मैट्रिक्स", mr: "आवश्यक पाण्याचे मॅट्रिक्स" },
  "pf.liters": { en: "LITERS", hi: "लीटर", mr: "लिटर" },
  "pf.pesticide": { en: "Pesticide", hi: "कीटनाशक", mr: "कीटकनाशक" },
  "pf.temperature": { en: "Temperature", hi: "तापमान", mr: "तापमान" },
  "pf.humidity": { en: "Humidity", hi: "नमी", mr: "आर्द्रता" },
  "pf.nitrogen": { en: "Nitrogen (N)", hi: "नाइट्रोजन (N)", mr: "नायट्रोजन (N)" },
  "pf.phosphorus": { en: "Phosphorus (P)", hi: "फास्फोरस (P)", mr: "फॉस्फरस (P)" },
  "pf.potassium": { en: "Potassium (K)", hi: "पोटेशियम (K)", mr: "पोटॅशियम (K)" },
  "pf.parcel_env": { en: "Parcel Environment", hi: "पार्सल पर्यावरण", mr: "पार्सल पर्यावरण" },
  "pf.health_score": { en: "Parcel Health Score", hi: "पार्सल स्वास्थ्य स्कोर", mr: "पार्सल आरोग्य गुण" },
  "pf.vitality_index": { en: "Vitality Index Optimal", hi: "जीवन शक्ति सूचकांक इष्टतम", mr: "जीवनशक्ती निर्देशांक इष्टतम" },
  "pf.anomaly_log": { en: "REAL-TIME ANOMALY LOG", hi: "रीयल-टाइम विसंगति लॉग", mr: "रिअल-टाइम विसंगती लॉग" },
  "pf.no_anomalies": { en: "No anomalies detected", hi: "कोई विसंगतियां नहीं मिलीं", mr: "कोणतीही विसंगती आढळली नाही" },
  "pf.search_placeholder": { en: "Search regional farmland (Punjab, Nashik, etc)...", hi: "क्षेत्रीय खेत खोजें (पंजाब, नासिक, आदि)...", mr: "प्रादेशिक शेतजमीन शोधा (पंजाब, नाशिक, इ.)..." },
  "pf.analysis": { en: "ANALYSIS", hi: "विश्लेषण", mr: "विश्लेषण" },
  "pf.smart_parcel_locked": { en: "Smart Parcel Locked", hi: "स्मार्ट पार्सल लॉक", mr: "स्मार्ट पार्सल लॉक केले" },
  "pf.detecting_plot": { en: "DETECTING FULL PLOT...", hi: "पूरा प्लॉट खोजा जा रहा है...", mr: "संपूर्ण प्लॉट शोधत आहे..." },
  "pf.confidence": { en: "Confidence", hi: "आत्मविश्वास", mr: "आत्मविश्वास" },
  "pf.click_map": { en: "Click map to select adjacent parcel", hi: "निकटवर्ती पार्सल चुनने के लिए मानचित्र पर क्लिक करें", mr: "शेजारील पार्सल निवडण्यासाठी नकाशावर क्लिक करा" },
  "pf.high": { en: "High", hi: "उच्च", mr: "उच्च" },
  "pf.medium": { en: "Medium", hi: "मध्यम", mr: "मध्यम" },
  "pf.low": { en: "Low", hi: "कम", mr: "कमी" },
  "pf.unknown": { en: "Unknown", hi: "अज्ञात", mr: "अज्ञात" },
  "pf.satellite": { en: "Satellite", hi: "उपग्रह", mr: "उपग्रह" },
  "pf.doc_assisted": { en: "Document Assisted", hi: "दस्तावेज़ सहायता प्राप्त", mr: "दस्तऐवज साहाय्यित" },
  "pf.drag_select": { en: "Drag to select area", hi: "क्षेत्र चुनने के लिए खींचें", mr: "क्षेत्र निवडण्यासाठी ओढा" },
  "pf.click_corners": { en: "Click corners to draw", hi: "बनाने के लिए कोनों पर क्लिक करें", mr: "काढण्यासाठी कोपऱ्यांवर क्लिक करा" },

  // Crops
  "crop.rice": { en: "Rice", hi: "चावल", mr: "तांदूळ" },
  "crop.wheat": { en: "Wheat", hi: "गेहूँ", mr: "गहू" },
  "crop.sunflower": { en: "Sunflower", hi: "सूरजमुखी", mr: "सूर्यफूल" },
  "crop.cotton": { en: "Cotton", hi: "कपास", mr: "कापूस" },
  "action.get_rec_for_crop": { en: "Get Recommendation for", hi: "के लिए सिफारिश प्राप्त करें", mr: "साठी शिफारस मिळवा" },
  "rec.for_crop": { en: "Recommendation for", hi: "के लिए सिफारिश", mr: "साठी शिफारस" },
  "action.clear_crop": { en: "Clear Crop Selection", hi: "फसल चयन साफ़ करें", mr: "पीक निवड पुसून टाका" },
  "rec.rice_water_tolerance": { en: "High water tolerance; flooding acceptable", hi: "उच्च जल सहनशीलता; बाढ़ स्वीकार्य", mr: "उच्च पाणी सहनशीलता; पूर स्वीकार्य" },
  "rec.rice_disease_watch": { en: "Watch for blast disease in humid conditions", hi: "नम परिस्थितियों में ब्लास्ट रोग पर नज़र रखें", mr: "दमट स्थितीत ब्लास्ट रोगाकडे लक्ष ठेवा" },
  "rec.wheat_drainage_needed": { en: "Ensure good drainage; avoid waterlogging", hi: "अच्छी जल निकासी सुनिश्चित करें; जलभराव से बचें", mr: "चांगला निचरा सुनिश्चित करा; पाणी साचणे टाळा" },
  "rec.wheat_rust_watch": { en: "Monitor for yellow rust", hi: "पीले रतुआ की निगरानी करें", mr: "पिवळ्या तांबेऱ्यावर लक्ष ठेवा" },
  "rec.sunflower_drought_tolerant": { en: "Drought tolerant; water sparingly", hi: "सूखा सहिष्णु; कम पानी दें", mr: "दुष्काळ सहनशील; कमी पाणी द्या" },
  "rec.sunflower_soil_prep": { en: "Avoid over-fertilizing nitrogen", hi: "नाइट्रोजन का अधिक उर्वरक करने से बचें", mr: "नायट्रोजनचे जास्त खत देणे टाळा" },
  "rec.cotton_moderate_water": { en: "Moderate irrigation; critical at boll formation", hi: "मध्यम सिंचाई; गूलर बनने के समय महत्वपूर्ण", mr: "मध्यम सिंचन; बोंडे लागताना महत्त्वाचे" },
  "rec.cotton_pest_watch": { en: "High risk of bollworms; scout regularly", hi: "गुलाबी सुंडी का उच्च जोखिम; नियमित रूप से निरीक्षण करें", mr: "बोंडअळीचा उच्च धोका; नियमित पाहणी करा" },
};
